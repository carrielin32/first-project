...
def block(blockID):
    readStimuli('trial_list_pilot_2.csv', query='block==%s' %(blockID))
    stimuli= readStimuli('trial_list_pilot_2.csv', query='block==%s' %(blockID))
    random.shuffle(stimuli)

    alertAndGo('The experiment will start i n 3s')
